...
const MotivationalQuotes: React.FC<MotivationalQuotesProps> = ({
  ...
  const [currentQuote, setCurrentQuote] = useState<(typeof QUOTES)[0] | null>(
    null
  );
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      ...
      >
        ...
        <div
          className={`absolute top-0 right-0 w-20 h-20 rounded-full blur-xl opacity-30 ${
        ...
        {/* Bottom decoration */}
        <div
          className={`mt-6 h-1 rounded-full mx-auto w-16 ${
            isDarkMode
